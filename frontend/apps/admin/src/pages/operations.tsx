...
export function GrantsPage() {
  ...
  return <>
    <PageHeader title="OAuth Grants" description={locale === "zh-CN" ? "查看设备授权并撤销 Access/Refresh Token 家族。" : "Inspect device authorizations and revoke access/refresh-token families."} actions={<RefreshButton onClick={() => void state.reload()} />} />
    {error && <Notice>{error}</Notice>}
