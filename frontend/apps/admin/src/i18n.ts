...
const zh = {
  ...
  createUser: "创建本地用户", username: "用户名", displayName: "显示名称", email: "邮箱", password: "初始密码", create: "创建", enabled: "启用", disabled: "停用", resetPassword: "重置密码",
  assignments: "角色授权", addAssignment: "添加授权", groupFirst: "建议优先绑定企业用户组；个人 Principal 仅用于临时或例外授权。", group: "用户组", principal: "个人 Principal", role: "角色", subjectType: "授权对象", subjectValue: "对象标识", saveDraft: "创建 Draft", validate: "校验 / Dry-run", publish: "发布", rollback: "回滚", targetRevision: "目标 Revision", reason: "变更原因", remove: "移除", candidate: "候选策略", current: "当前已发布",
...
const en: Record<keyof typeof zh, string> = {
  ...
  createUser: "Create local user", username: "Username", displayName: "Display name", email: "Email", password: "Initial password", create: "Create", enabled: "Enabled", disabled: "Disabled", resetPassword: "Reset password",
  assignments: "Role assignments", addAssignment: "Add assignment", groupFirst: "Prefer enterprise groups. Direct Principal assignments should be temporary exceptions.", group: "Group", principal: "Principal", role: "Role", subjectType: "Subject type", subjectValue: "Subject identifier", saveDraft: "Create draft", validate: "Validate / Dry-run", publish: "Publish", rollback: "Rollback", targetRevision: "Target revision", reason: "Change reason", remove: "Remove", candidate: "Candidate policy", current: "Published",
