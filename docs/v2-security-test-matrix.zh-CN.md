...
| IAM 写入与高风险操作 | 写入使用 CSRF、幂等键、ETag、所有权检查和事务审计；先持久化撤销再收敛运行时 | `internal/controlplane/admin/httpapi/*_test.go`、`internal/controlplane/admin/operations/*_test.go`、`e2e/helm/chart_test.go` |
