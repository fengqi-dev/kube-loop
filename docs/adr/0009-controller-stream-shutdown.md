# ADR 0009: Controller stream shutdown and restart semantics
...
The Controller owns one cancellable root context and explicitly tracks every
...
An active Pod exec is not migrated or replayed across Controller processes.
The old stream ends as cancelled; after the replacement Controller is ready,
