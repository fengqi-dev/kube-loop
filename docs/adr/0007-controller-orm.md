# ADR 0007: Controller persistence uses Bun as a SQL-first ORM
...
Controller already has stable Repository and TransactionManager contracts,
...
Use Bun v1.2.18 as the Controller's internal SQL-first ORM. Bun wraps the
...
Bun models are private storage rows and must not appear in Controller API or
