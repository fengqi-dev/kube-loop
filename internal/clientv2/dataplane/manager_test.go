...
func (core *testCore) Close() error          { core.closeOnce.Do(func() { close(core.done) }); return nil }
...
func (core *testCore) Config() []byte                                               { return nil }
func (core *testCore) ReadLogs(context.Context) ([]string, error)                   { return nil, nil }
func (core *testCore) UpdateDNSNamespace(context.Context, string) error             { return nil }
func (core *testCore) UpdateHostAliases(context.Context, []singbox.HostAlias) error { return nil }
