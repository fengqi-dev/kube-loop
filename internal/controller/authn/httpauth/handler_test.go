...
import (
	...
	"github.com/fengqi-dev/kube-loop/internal/controller/authn/development"
...
func TestHTTPAuthenticationRejectsUnknownJSONAndHidesRevocationExistence(t *testing.T) {
	...
	if oversizedResponse.Code != http.StatusBadRequest || strings.Contains(oversizedResponse.Body.String(), "oversized-auth-secret") {
...
func newHandlerTestServer(t *testing.T) (*Handler, *handlerOIDCProvider) {
	t.Helper()
