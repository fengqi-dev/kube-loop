...
func (relay *mirrorRelay) acceptTCP(ctx context.Context, binding tcpBinding) error {
	for {
...
func (relay *mirrorRelay) serveTCP(ctx context.Context, port Port, client net.Conn) {
...
func (relay *mirrorRelay) readUDP(ctx context.Context, index int, binding udpBinding) error {
