...
// WriteAll writes payload in full, resuming after short writes. A writer that
// reports neither progress nor an error would spin forever, so that case ends
// the loop with io.ErrShortWrite.
