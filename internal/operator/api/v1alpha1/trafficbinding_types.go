...
// RelayEndpoint is a Controller-owned listener reachable from the cluster.
...
type TrafficBindingSpec struct {
	...
	// Controller listener, never a desktop-provided destination.
	// +optional
